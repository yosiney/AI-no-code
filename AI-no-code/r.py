...
def ventana1():
    global ventana1
    ventana1 = Tk() #crear la ventana
    ventana1.geometry("800x500") # dimension de la ventana
    ventana1.title("AI no code")
    img = Image.open('12.png')
    img = img.resize((100, 88), Image.ANTIALIAS) # Redimension (Alto, Ancho)
    ...
    img2 = img2.resize((100,88), Image.ANTIALIAS) # Redimension (Alto, Ancho)
